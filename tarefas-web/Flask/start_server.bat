...
:: Verifica se já existe servidor rodando na porta 5000 (porta padrão do Flask)
echo.
echo Verificando porta 5000...
netstat -ano | findstr :5000 >nul 2>&1
if %errorlevel% == 0 (
    echo ✗ ERRO: Porta 5000 ja esta em uso!
    echo   Pare o processo existente primeiro ou use uma porta diferente.
    echo    --------------------------------------------------------------
    echo ✓ Abrindo no navegador: http://localhost:5000
